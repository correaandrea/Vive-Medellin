...
export default function Register () {
  ...
  return (
    <div className='flex flex-col min-h-dvh bg-background'>
        ...
        <div className="flex-grow flex justify-center items-center bg-background py-15 lg:py-10 lg:px-50 lg:w-full 2xl:px-230">
            <div className="flex flex-col bg-white rounded-xl shadow-md gap-y-2 p-10 lg:p-10 max-w-[360px] sm:max-w-md lg:max-w-lg w-full mx-auto py-16">
                ...
                <div className='flex flex-col items-center gap-2'>
                    ...
                    <Button iconName='line-md:account-add'>Crear cuenta</Button>
                </div>
            </div>
        </div>
